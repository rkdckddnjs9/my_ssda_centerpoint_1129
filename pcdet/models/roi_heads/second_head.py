...
class SECONDHead(RoIHeadTemplate):
    ...
    def roi_grid_pool(self, batch_dict):
        ...
        #dataset_cfg = batch_dict['dataset_cfg'] # get dataset cfg info
        min_x = 0 #dataset_cfg.POINT_CLOUD_RANGE[0]
        min_y = -40 #dataset_cfg.POINT_CLOUD_RANGE[1]
        voxel_size_x = 0.05 # dataset_cfg.DATA_PROCESSOR[-1].VOXEL_SIZE[0]
        voxel_size_y = 0.05 #dataset_cfg.DATA_PROCESSOR[-1].VOXEL_SIZE[1]
