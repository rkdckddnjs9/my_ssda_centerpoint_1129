...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    #CLASS_NAMES = ['car', 'pedestrian', 'cyclist', 'van', 'person_sitting', 'truck'] #kitti
    # CLASS_NAMES = ['car', 'truck', 'bus', 'motorcycle', 'pedestrian'] #omega
    CLASS_NAMES = ['car','truck', 'construction_vehicle', 'bus', 'trailer', 'barrier', 'motorcycle', 'bicycle', 'pedestrian', 'traffic_cone'] #nuscenes
    MIN_HEIGHT = [40, 25, 25]
    MAX_OCCLUSION = [0, 1, 2]
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    ...
    #                         [0.5, 0.5, 0.5, 0.25, 0.25, 0.25]])
    overlap_0_7 = np.array([[0.7, 0.7, 0.5, 0.7, 0.7, 0.5, 0.5, 0.5, 0.5, 0.5], 
                            [0.7, 0.7, 0.5, 0.7, 0.7, 0.5, 0.5, 0.5, 0.5, 0.5],
                            [0.7, 0.7, 0.5, 0.7, 0.7, 0.5, 0.5, 0.5, 0.5, 0.5]])
    overlap_0_5 = np.array([[0.5, 0.5, 0.25, 0.5, 0.5, 0.25, 0.25, 0.25, 0.25, 0.25 ],
                            [0.5, 0.5, 0.25, 0.5, 0.5, 0.25, 0.25, 0.25, 0.25, 0.25],
                            [0.5, 0.5, 0.25, 0.5, 0.5, 0.25, 0.25, 0.25, 0.25, 0.25]])
...
def get_official_eval_5class_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    overlap_0_7 = np.array([[0.7, 0.7, 0.7, 0.5, 0.5], 
                            [0.7, 0.7, 0.7, 0.5, 0.5],
                            [0.7, 0.7, 0.7, 0.5, 0.5]])
    overlap_0_5 = np.array([[0.5, 0.5, 0.5, 0.25, 0.25 ],
