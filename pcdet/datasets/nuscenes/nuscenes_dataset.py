...
class NuScenesDataset(DatasetTemplate):
    ...
    def nuscenes_kitti_format_eval(self, eval_det_annos, eval_gt_annos, class_names):
        from ..kitti.kitti_object_eval_python import eval as kitti_eval
    ...
    def nuscenes_kitti_format_5class_eval(self, eval_det_annos, eval_gt_annos, class_names):
        from ..kitti.kitti_object_eval_python import eval as kitti_eval
        ...
        for x in class_names:
            if x in map_name_to_kitti:
                ...
                kitti_class_names.append('Person_sitting')
        ap_result_str, ap_dict = kitti_eval.get_official_eval_5class_result(
            gt_annos=eval_gt_annos,
            dt_annos=eval_det_annos,
            current_classes=kitti_class_names)
        return ap_result_str, ap_dict
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        elif kwargs['eval_metric'] == 'nuscenes_kitti_format':
            eval_det_annos = copy.deepcopy(det_annos)
            eval_gt_annos = copy.deepcopy(self.infos)
            return self.nuscenes_kitti_format_eval(eval_det_annos, eval_gt_annos, class_names)
        elif kwargs['eval_metric'] == 'nuscenes_kitti_format_5class':
            eval_det_annos = copy.deepcopy(det_annos)
            eval_gt_annos = copy.deepcopy(self.infos)
            return self.nuscenes_kitti_format_5class_eval(eval_det_annos, eval_gt_annos, class_names)
